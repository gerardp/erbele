...
- (void)insertSyntaxDefinitions
{
	...
	NSString *path = [[[[NSHomeDirectory() stringByAppendingPathComponent:@"Library"] stringByAppendingPathComponent:@"Application Support"] stringByAppendingPathComponent:@"Erbele"] stringByAppendingPathComponent:@"SyntaxDefinitions.plist"];
